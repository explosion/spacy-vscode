...
// This script contains code for working with the VScode Python Extension API
...
export const onDidChangePythonInterpreterEvent =
...
export async function getPythonExtensionAPI(): Promise<
  IExtensionApi | undefined
> {
